...
def trends(board: dict) -> None:
    ...
    st.bar_chart(frame.head(20).set_index("Player")[["Season HR Rate", "Last 30 HR Rate", "Last 7 HR Rate"]], height=430)
...
def parks(board: dict) -> None:
    ...
    st.bar_chart(team_summary.set_index("Team")[["Projection Percentile", "Dinger Score"]], height=390)

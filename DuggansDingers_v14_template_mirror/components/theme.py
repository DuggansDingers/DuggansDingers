...
/* Header / approved template navigation */
.dd-logo-shell{height:96px;display:flex;align-items:center;justify-content:flex-start;overflow:visible}
.dd-logo-shell img{width:min(290px,100%);height:96px;object-fit:contain;object-position:left center;filter:drop-shadow(0 0 20px rgba(34,131,255,.22))}
div[data-testid="stRadio"]{height:98px;display:flex;align-items:center;background:transparent;border:0;padding:0;margin:0;overflow-x:auto;scrollbar-width:none}
div[data-testid="stRadio"]::-webkit-scrollbar{display:none}
div[data-testid="stRadio"]>div{width:100%;display:flex!important;align-items:stretch!important;justify-content:space-around!important;gap:4px!important;flex-wrap:nowrap!important}
div[data-testid="stRadio"] label{position:relative;min-width:100px;min-height:96px;display:flex!important;align-items:center!important;justify-content:center!important;padding:0 11px!important;border:0!important;border-radius:0!important;background:transparent!important;cursor:pointer}
div[data-testid="stRadio"] label>div:first-child{display:none!important}
div[data-testid="stRadio"] label p{display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;gap:7px!important;margin:0!important;color:#f4f8fc!important;font-size:.73rem!important;font-weight:800!important;line-height:1!important;text-transform:uppercase!important;white-space:nowrap}
div[data-testid="stRadio"] label p:before{display:block;font-size:1.55rem;line-height:1;color:#fff;filter:drop-shadow(0 0 8px rgba(255,255,255,.18))}
div[data-testid="stRadio"] label:nth-child(1) p:before{content:'⌂'}
div[data-testid="stRadio"] label:nth-child(2) p:before{content:'▤'}
div[data-testid="stRadio"] label:nth-child(3) p:before{content:'▦'}
div[data-testid="stRadio"] label:nth-child(4) p:before{content:'☀'}
div[data-testid="stRadio"] label:nth-child(5) p:before{content:'◉'}
div[data-testid="stRadio"] label:nth-child(6) p:before{content:'♜'}
div[data-testid="stRadio"] label:has(input:checked){background:linear-gradient(180deg,rgba(12,63,108,.20),rgba(14,76,130,.12))!important}
div[data-testid="stRadio"] label:has(input:checked):after{content:'';position:absolute;left:12px;right:12px;bottom:0;height:3px;border-radius:3px;background:#2ea8ff;box-shadow:0 0 14px #2ea8ff}
div[data-testid="stRadio"] label:has(input:checked) p:before{color:#9fd6ff;filter:drop-shadow(0 0 9px #2ea8ff)}

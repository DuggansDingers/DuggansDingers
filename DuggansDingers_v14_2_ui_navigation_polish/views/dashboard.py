...
''',
    ...
    st.markdown(
        '<div class="dd-home-table-title"><div><i>♛</i><b>TOP 25 HOME RUN RANKINGS</b><span>Probable pitchers, real power windows, model probability, and live price</span></div><a href="?view=daily-board" target="_self">⚙ CUSTOMIZE COLUMNS</a></div>',
        unsafe_allow_html=True,
    )
    ...
    render_neon_table(rows, columns, key="home_top_25", max_height=405)

...
def render(board: dict) -> None:
    ...
    hero(
        ...
        "Every card now carries the projected opposing starter, pitcher HR/9 and ERA, plus real season and rolling power history.",
    ...
    for start in range(0, len(visible), 3):
        ...
        for offset, player in enumerate(visible[start:start + 3]):
